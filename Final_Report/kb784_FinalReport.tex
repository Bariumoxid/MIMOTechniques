...
\subsection{Ethical Statement}
	\begin{highlightblock}
	This project is entirely simulation-based and does not involve human participants, personal data, physical laboratory experiments, or deployment of communication hardware. Therefore, no direct safety, privacy, or human-subject ethical risks are identified. The main ethical consideration is the accurate and transparent reporting of the simulation assumptions, limitations, and results.
	
	From an environmental perspective, the project requires computational resources for SNR sweeps, channel simulations, and MIMO configuration studies. Although this has a lower environmental impact than physical prototyping or laboratory testing, unnecessary computation was avoided where possible by using a consistent baseline setup and focusing parameter sweeps on the most relevant variables.
	
	The project may have positive social and environmental implications if the studied CSI feedback and MIMO techniques contribute to more efficient wireless communication systems. Improved link adaptation can support better spectral efficiency and more reliable connectivity. However, such benefits depend on wider system-level deployment, and advanced communication techniques may also increase implementation complexity and cost. Therefore, the results are presented as link-level simulation findings rather than general claims about real-world network performance.
	\end{highlightblock}
