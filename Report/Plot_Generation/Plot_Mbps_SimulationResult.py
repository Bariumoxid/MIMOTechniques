...
# === 配置 ===
file_path = r'C:\Wichtig\cam\IIB\ForthYearProj\Data\mbps_data_tdl_cdl_csi_default.xlsx'
...
schemes = ['CDL-A','CDL-B','CDL-C', 'CDL-C_2L', 'CDL-C_4L']
...
# 右图：BLER
# =========================
schemes = ['TDL-A','TDL-B','TDL-C', 'CDL-C_3L', 'CDL-C_4L']
for scheme in schemes:
    t_col = f'{scheme}'
