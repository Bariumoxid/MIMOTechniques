...
\subsection{MATLAB Simulation Framework}
	...
	\subsection{System Configuration and Experimental Design}
		...
		\hl{add reference for this table, TS38.101-4}
		\begin{table}[H]
			\centering
...
\section{Model Validation and Baseline CSI-Feedback Downlink Behaviour}
	...
	\hl{also why throughput mbps not BLER any more}
...
\begin{table}[H]
	...
	\begin{tabular}{|ll|c|}
		...
		\multicolumn{2}{|l|}{Antenna configuration}                        a                                                                                               & 4Tx4Rx              \\ \hline
