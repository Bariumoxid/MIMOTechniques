...
\section*{Key Results and Interpretation}
	\begin{highlightblock}
		...
		Increasing mobility shifts the throughput curve towards higher SNR. For example, the SNR required to reach 80 Mbps increases from 7.7 dB at 10 Hz to 10.5 dB at 390 Hz. This degradation is consistent with a combination of faster channel variation, CSI ageing, and reduced effectiveness of link adaptation.
		
		CSI reporting periodicity mainly affects the transition region of the throughput curve rather than the high-SNR saturation level. Relative to the 10-slot baseline, long reporting periods introduce measurable SNR penalties. At 10 Hz, increasing the period to 160 slots produces a 2.4 dB penalty at the selected reference throughput. Reducing the period to 4 slots provides only a modest improvement, with the largest observed gain being approximately 0.5 dB at 100 Hz. Under the simulated assumptions, the value of more frequent CSI updates therefore depends on both mobility and the operating SNR region.
	\end{highlightblock}
\section*{Conclusion}
